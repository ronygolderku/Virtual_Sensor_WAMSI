...
process_and_upload_dataset(
    ...
    s3_folder="csiem-data/data-lake/ESA/GlobColor/Plankton/Polygon/",
...
process_and_upload_dataset(
    ...
    s3_folder="csiem-data/data-lake/ESA/GlobColor/Transp/Polygon/",
    shapefiles=shapefiles,
)
...
process_and_upload_dataset(
    ...
    s3_folder="csiem-data/data-lake/ESA/GlobColor/Reflectance/Polygon/",
    shapefiles=shapefiles,
)
...
process_and_upload_dataset(
    ...
    s3_folder="csiem-data/data-lake/ESA/GlobColor/Optics/Polygon/",
    shapefiles=shapefiles,
)
...
process_and_upload_dataset(
    ...
    s3_folder="csiem-data/data-lake/ESA/GlobColor/PP/Polygon/",
    shapefiles=shapefiles,
)
